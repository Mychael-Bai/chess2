...
class ChineseChess:
    ...
    def __init__(self):
        ...
        self.window = tk.Tk()
        self.window.title("Chinese Chess 6.7.87(latest with switch feature)")
    ...
    def switch_colors(self):
        """Switch the board orientation while keeping AI on top and red moves first"""
        ...
        # Flip the positions and swap colors
        for row in range(10):
            for col in range(9):
        ...
        self.selected_piece = None
        self.highlighted_positions = []
        self.current_player = 'red'  # Always start with red
        self.move_history = []  # Clear move history as this is effectively a new game
        
        # Redraw the board
        self.draw_board()
        
        # If red is now on top (AI's color when flipped), make AI move
        if self.flipped:
            ...
            if self.selected_piece:
                ...
                # If clicking on a valid move position
                    ...
                    if self.is_in_check(self.current_player):
                        ...
                        # Reset selected piece and redraw
                        self.selected_piece = None
                        self.draw_board()
    ...
    def make_ai_move(self):
        ...
        # Don't make a move if it's not AI's turn
        if self.current_player != ai_color:
            return
