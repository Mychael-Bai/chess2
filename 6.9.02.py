        ...
        if closest:
            ...
            if tags:
                ...
                if self.available_pieces['red' if piece.startswith('R') else 'black'][piece] > 0:
                    ...
                    # Clear previous highlights and highlight this selection
                    self.highlighted_positions = [(center_y / self.cell_size, center_x / self.cell_size)]
                    self.draw_board()
    ...
    def on_click(self, event):
        ...
        if self.piece_setting_mode:
            ...
            if 0 <= row < 10 and 0 <= col < 9 and self.piece_to_place:
                ...
                # Update highlights to show just the placed position
                self.highlighted_positions = [(row, col)]
