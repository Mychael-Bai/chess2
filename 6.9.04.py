...
class ChineseChess:
    ...
    def __init__(self):
        ...
        self.button_frame.pack(side=tk.LEFT, padx=(15, 0))  # Add padding between board and button
    ...
    def create_pieces_frame(self):
        ...
        piece_canvas_size = self.cell_size * 8  # Make the canvas wider to fit all pieces
        ...
        def create_piece_section(frame, pieces_dict, color_prefix):
            ...
            if color_prefix == 'R':
                piece_layout = [
                    [('R車',1), ('R馬',1), ('R相',1), ('R仕',1), ('R帥',1), ('R仕',1), ('R相',1), ('R馬',1), ('R車',1)],
                    [None, None, None, None, None, None, None, None, None],
                    [None, ('R炮',1), None, None, None, None, None, ('R炮',1), None],
                    [('R兵',1), None, ('R兵',1), None, ('R兵',1), None, ('R兵',1), None, ('R兵',1)]
                ]
            else:  # Black pieces
                piece_layout = [
                    [('B車',1), ('B馬',1), ('B象',1), ('B士',1), ('B將',1), ('B士',1), ('B象',1), ('B馬',1), ('B車',1)],
                    [None, None, None, None, None, None, None, None, None],
                    [None, ('B炮',1), None, None, None, None, None, ('B炮',1), None],
                    [('B卒',1), None, ('B卒',1), None, ('B卒',1), None, ('B卒',1), None, ('B卒',1)]
                ]
