...
class ChineseChess:
    ...
    def __init__(self):
        ...
        self.window.title("Chinese Chess 6.9.95 (set pieces mode restart ok)")
    ...
    def show_centered_warning(self, title, message):
        """Shows a warning messagebox centered on the main window"""
        ...
        # Calculate position to center the warning window
        x = window_x + (window_width - warn_window.winfo_width()) // 2
        y = window_y + (window_height - warn_window.winfo_height()) // 2
        
        # Position and show window
        warn_window.geometry(f"+{x}+{y}")
        warn_window.grab_set()
        warn_window.deiconify()
        warn_window.focus_force()
