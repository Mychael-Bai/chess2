...
class ChineseChess:
    ...
    def __init__(self):
        ...
        # Only allow height resizing, lock width
        ...
        self.window.title("Chinese Chess 6.9.88 (all buttons are ttk.Button and without dotted rectangle after click button finished)")
        ...
        width = self.records_min_width if hasattr(self, 'records_seen') and self.records_seen else self.base_min_width
        self.window.minsize(width, self.min_height)
