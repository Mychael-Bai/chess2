    ...
    def on_window_configure(self, event):
        ...
        if event.widget == self.window and not self.processing_resize:
            try:
                ...
                # Only enforce width constraints, allow height to be freely adjusted
                if current_width < min_width:
                    new_width = min_width
                    need_resize = True
                elif current_width > min_width and not self.records_seen:
                    new_width = min_width
                    need_resize = True
                elif current_width > self.records_min_width and self.records_seen:
                    new_width = self.records_min_width
                    need_resize = True
                
                # Only enforce minimum height, allow upward resizing
                ...
                # Update minimum size constraint for width only
                self.window.minsize(min_width, self.min_height)
