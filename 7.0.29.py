...
class ChineseChess:
            ...
            if self.selected_piece:
                ...
                # If clicking on a valid move position
                    ...
                    if self.is_in_check(self.current_player):
                        ...
                        if self.switch_operation == False:
                            self.record_if_switched.append(0)
                        else:
                            self.record_if_switched.append(1)
    ...
    def next_replay_move(self):
        ...
        if self.record_if_switched[self.current_replay_index - 1] == 1:
            self.switch_colors()
