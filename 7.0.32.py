...
class ChineseChess:
                ...
                # If clicking on a valid move position
                    ...
                    if self.is_in_check(self.current_player):
                        ...
                        if self.check_rotate == True:
                            ...
                            print('\nexecuted')
                            print(self.rotate_single_highlight[0], self.rotate_single_highlight[1])
                            print((start_row, start_col), (row, col))
                            print(self.highlighted_positions)
    ...
    def next_replay_move(self):
        ...
        print(self.current_replay_index)
    ...
    def draw_board(self):
        ...
        if self.replay_mode == True:
            if self.rotate_replay_board[self.current_replay_index]:

                self.board = [row[:] for row in self.rotate_replay_board[self.current_replay_index][0]]
        ...
        if self.replay_mode == True:
            ...
            if self.rotate_replay_board[self.current_replay_index]:
                ...
                self.highlighted_positions[0] = self.rotate_replay_board[self.current_replay_index][1][0]
                self.highlighted_positions[1] = self.rotate_replay_board[self.current_replay_index][1][1]
