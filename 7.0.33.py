...
class ChineseChess:
    ...
    def __init__(self):
        ...
        self.window.title("Chinese Chess 7.0.25 (latest version restart ok even color switched, height resizable, spaces ok, replay previous move ok)")
                ...
                # If clicking on a valid move position
                    ...
                    if self.is_in_check(self.current_player):
                        ...
                        if self.check_rotate == True:
                            ...
                            self.rotate_replay_board.append([self.rotate_board, self.rotate_single_highlight])

                        else:
                            self.rotate_replay_board.append(None)
    ...
    def draw_board(self):
        ...
        if self.replay_mode == True:
            if self.current_replay_index > 0 and self.rotate_replay_board[self.current_replay_index - 1]:
                ...
                self.board = [row[:] for row in self.rotate_replay_board[self.current_replay_index - 1][0]]
        ...
        if self.replay_mode == True:
            ...
            if self.current_replay_index > 0 and self.rotate_replay_board[self.current_replay_index - 1]:
                ...
                self.highlighted_positions[0] = self.rotate_replay_board[self.current_replay_index - 1][1][0]
                self.highlighted_positions[1] = self.rotate_replay_board[self.current_replay_index - 1][1][1]
        ...
        # Draw top numbers
        if self.replay_mode == True and self.current_replay_index > 0 and self.rotate_replay_board[self.current_replay_index - 1]:
            top_numbers = red_numbers_flipped if not self.flipped else black_numbers
        ...
        # Draw bottom numbers
        if self.replay_mode == True and self.current_replay_index > 0 and self.rotate_replay_board[self.current_replay_index - 1]:
            bottom_numbers = black_numbers_flipped if not self.flipped else red_numbers
