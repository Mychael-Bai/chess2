...
class ChineseChess:
    ...
    def __init__(self):
        ...
        self.suspend_toggle_records = False
        ...
        self.window.title("Chinese Chess 7.0.68 (latest version, king, sdvisor, elephant and pawn must be in correct positions)")
    ...
    def toggle_piece_setting_mode(self):
        ...
        if self.records_hidden_by_piece_set == True and self.piece_setting_mode == False and self.suspend_toggle_records == False:
            self.toggle_records()
            self.records_hidden_by_piece_set = False
        ...
        if self.piece_setting_mode:
            ...
            if not self.validate_piece_positions():
                self.suspend_toggle_records = True
