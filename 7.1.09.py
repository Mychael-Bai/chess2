...
class MCTSNode:
    def __init__(self, state, flip_state, parent=None, move=None, player=None):
        ...
        self.game_rules = GameRules(state=self.state, flipped=self.flip_state)
...
class MCTS:
    def __init__(self, initial_state, flip_state, game_rules, player, iterations=1000):
...
class ChineseChess:
    ...
    def make_ai_move(self):
        ...
        mcts = MCTS(
            ...
            game_rules=self.game_rules,  # Pass the game class instance as it contains rules
