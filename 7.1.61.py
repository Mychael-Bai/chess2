...
class ChineseChess:
    ...
    def __init__(self):
        ...
        # Create a frame for the timer at the top right
        self.timer_frame = tk.Frame(self.main_frame)
        self.timer_frame.pack(anchor='ne', padx=10, pady=(20, 0))  # Align with top pieces
        
        # Create timer label with fixed width font
        self.timer_label = tk.Label(
            self.timer_frame,
            text="000",
            font=('Courier', 20, 'bold'),  # Fixed width font
            width=3,
            anchor='e'
        )
