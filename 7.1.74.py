...
class MCTS:
    ...
    def get_best_move(self):
        ...
        CHECKMATE_TIME_LIMIT = 20  # Maximum time for checkmate search
        ...
        # Calculate remaining time for MCTS search
        remaining_time = TOTAL_TIME_LIMIT - (time.time() - overall_start_time)
