...
class ChineseChess:
                ...
                if pair:  # If there's at least one move in the pair
                    ...
                    try:
                        ...
                        if from_pos and to_pos:
                            ...
                            chinese_notation = self.get_move_text(from_pos, to_pos, piece, current_board)
    ...
    def get_move_text(self, from_pos, to_pos, piece, board=None):
        """
        ...
        position_descriptor = self.get_piece_position_descriptor(from_pos, to_pos, piece, board)
