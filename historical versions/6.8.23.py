...
class ChineseChess:
    ...
    def switch_colors(self):
        """Switch the board orientation while keeping AI on the red side when flipped"""
        ...
        if self.is_checkmate(opponent_color) or self.is_checkmate(ai_color):
            self.game_over = True
            
        if self.flipped and not self.is_checkmate(opponent_color):
