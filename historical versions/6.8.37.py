...
class ChineseChess:
    ...
    def __init__(self, master):
        ...
        self.master = master
        self.master.title("Chinese Chess")
        
        # Create canvas
        self.canvas = tk.Canvas(master, width=720, height=800)
        self.canvas.pack(side='left')  # Pack canvas to the left
        

        # Create new frame for print contents
        self.print_frame = tk.Frame(master)
        self.print_frame.pack(side='top')
        
        # Add text widget to print frame
        self.print_text = tk.Text(self.print_frame, width=30, height=10)
    ...
    def update_print_display(self, message):
        """Update the print display with new message"""
        self.print_text.delete(1.0, tk.END)
        self.print_text.insert(tk.END, message)
    ...
    def make_ai_move(self):
        ...
        self.update_print_display(f"AI is playing: {ai_color}")  # Fixed: removed master argument
