...
class ChineseChess:
    ...
    def __init__(self):
        ...
        min_width = 900  # Adjust this value based on your board size and button panel width
        ...
        self.button_frame.pack(side=tk.LEFT, padx=(10, 0))  # Add padding between board and button
